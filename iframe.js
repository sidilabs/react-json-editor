...
const d = {
  "./src/stories/JsonEditor.stories.ts": async () => import("./JsonEditor.stories-f3e3bda1.js")
};
async function p(t) {
  return d[t]();
}
