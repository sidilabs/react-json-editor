import { b as lr, R as cr, r as ue } from "./index-7f31bf7a.js";
import { c as Bu, g as Gu } from "./_commonjsHelpers-de833af9.js";
var Iu = {},
  ee = lr;
...
var X = Et,
  ...
  ie = Bt;
function ht(u, e, r) {
  e == "__proto__" && ie ? ie(u, e, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (u[e] = r);
}
var yt = ht;
function dt(u) {
...
var fn = eu,
  ...
  hn = zu;
function yn() {
  (this.size = 0), (this.__data__ = { hash: new Fe(), map: new (hn || Bn)(), string: new Fe() });
}
var dn = yn;
function vn(u) {
  var e = typeof u;
...
function zn(u, e) {
  ...
  if (r instanceof Kn) {
    var t = r.__data__;
    if (!Hn || t.length < qn - 1) return t.push([u, e]), (this.size = ++r.size), this;
...
function zs(u, e, r, t, a, i) {
  ...
  if (F && !T) return i || (i = new Ru()), n || Hs(u) ? js(u, e, r, t, a, i) : Gs(u, e, p, r, t, a, i);
  if (!(r & Ws)) {
...
function Xu(u, e) {
  if (typeof u != "function" || (e != null && typeof e != "function")) throw new TypeError(gD);
  var r = function () {
    var t = arguments,
...
(function () {
  ...
  function F(s) {
    return (
      "><(){}[],:*|?!=".indexOf(String.fromCharCode(s)) === -1 && !p.code.isWhiteSpace(s) && !p.code.isLineTerminator(s)
    );
  }
  function m(s, D, y, o) {
...
`;
  ...
  function L() {
      ...
      if (((s = c()), (D = r.charCodeAt(a)), s === "0")) {
        if (D === 120 || D === 88) {
          ...
          return (
            ...
            a < t && ((D = r.charCodeAt(a)), p.code.isIdentifierStartES5(D) && B.throwError("unexpected token")),
            (l = parseInt(s, 16)),
            e.NUMBER
          );
        }
        if (p.code.isOctalDigit(D)) {
          ...
          return (
            a < t &&
              ((D = r.charCodeAt(a)),
              (p.code.isIdentifierStartES5(D) || p.code.isDecimalDigit(D)) && B.throwError("unexpected token")),
            (l = parseInt(s, 8)),
            e.NUMBER
          );
        }
    ...
    if (D === 46) for (s += c(); a < t && ((D = r.charCodeAt(a)), !!p.code.isDecimalDigit(D)); ) s += c();
    if (D === 101 || D === 69)
      if (
        ((s += c()),
        (D = r.charCodeAt(a)),
  ...
  function k() {
    ...
    return _(e.RPAREN, "UnionType should end with )"), d({ type: u.UnionType, elements: s }, [D, i]);
  }
  function f() {
    var s,
      D = a - 1,
  ...
  function nu() {
    ...
    return (
      C(e.NAME),
      n === e.COLON && (s === "module" || s === "external" || s === "event") && (_(e.COLON), (s += ":" + l), C(e.NAME)),
  ...
  function V() {
    ...
    return (
      (s = nu()),
      n === e.DOT_LT || n === e.LT
        ? (M(), (D = Eu()), C(e.GT), d({ type: u.TypeApplication, expression: s, applications: D }, [y, i]))
        : s
    );
  }
  function pu() {
    ...
    return (
      ...
      n !== e.RPAREN &&
        (n === e.NAME && (l === "this" || l === "new")
          ? ((s = l === "new"), _(e.NAME), C(e.COLON), (D = V()), n === e.COMMA && (_(e.COMMA), (y = $())))
          : (y = $())),
      C(e.RPAREN),
      (o = null),
      n === e.COLON && (o = pu()),
  ...
  function iu() {
    ...
    switch (n) {
      ...
      case e.LBRACE:
        return g();
      case e.NAME:
        if (((D = a - l.length), l === "null")) return _(e.NAME), d({ type: u.NullLiteral }, [D, i]);
  ...
  function U() {
    ...
    return n === e.QUESTION
      ...
      : n === e.BANG
      ? ((D = a - 1), _(e.BANG), d({ type: u.NonNullableType, expression: iu(), prefix: !0 }, [D, i]))
      : ((D = i),
        (s = iu()),
        n === e.BANG
  ...
  function J() {
    ...
    return n === e.REST
      ...
      : ((s = K()), n === e.EQUAL ? (_(e.EQUAL), d({ type: u.OptionalType, expression: s }, [0, a])) : s);
  }
  function fu(s, D) {
    var y;
    return (
      ...
      M(),
      (y = K()),
      D && D.midstream ? { expression: y, index: i } : (n !== e.EOF && B.throwError("not reach to EOF"), y)
    );
  }
  function Ou(s, D) {
    var y;
...
\u2028\u2029])`;
    ...
    (function (C) {
          ...
          if (E(this._title))
            try {
              if (
                ...
                !this._tag.type && !B(this._title) && !T(this._title) && !this.addError("Missing or invalid tag type"))
              )
                return !1;
            } catch (o) {
      ...
      function y(o, A) {
        ...
        for (
          G = g.length, f = 0, j = 0, Eu = A.recoverable, V = A.sloppy, pu = A.strict, N = D(A.preserveWhitespace);
          (v = s(A)), !!v;
      ...
      case "union":
        ...
        return (
          u.elements.every((i) => i.name === "literal")
            ? (a = { ...t, name: "enum", value: u.elements.map((i) => nr(i.value)) })
...
var LA = { tags: ["param", "arg", "argument", "returns", "ignore", "deprecated"] },
  MA = (u, e = LA) => {
...
var go = (u) => {
  ...
  Co = ((u) => ((u.AUTO = "auto"), (u.CODE = "code"), (u.DYNAMIC = "dynamic"), u))(Co || {}),
  lo = Ue,
...
//# sourceMappingURL=_getPrototype-f4ad5b2f.js.map
